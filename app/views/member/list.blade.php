		...
		<div class="clear mainbox-title-container">
		        <div class="tools-container" style="display:none;">
					<span class="action-add">
						<a href="/property/create">Add Member</a>
					</span>
                </div>
					...
					<table class="items">
						<thead>
							<tr>
								...
								<th width="30%">{{SortableTrait::link_to_sorting_action("email", "Email")}}</th>								
								<th width="15%">{{SortableTrait::link_to_sorting_action("contact", "Contact")}}</th>
								<th width="10%">{{SortableTrait::link_to_sorting_action("point", "Collected Pointed")}}</th>
